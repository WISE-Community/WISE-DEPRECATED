...
exports.config = {
    ...
    'authoringTool/info/info.spec.js', 'authoringTool/node/node.spec.js', 'authoringTool/notebook/notebook.spec.js', 'authoringTool/project/project.spec.js', 'authoringTool/projectList/projectList.spec.js'],
    multiCapabilities: [{
        'browserName': 'chrome',
