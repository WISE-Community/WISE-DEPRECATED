...
exports.config = {
  ...
  suites: {
    ...
    components: ['components/multipleChoice/multipleChoiceCheckbox.spec.js', 'components/multipleChoice/multipleChoiceRadio.spec.js', 'components/openResponse/openResponse.spec.js'],
    portal: [
