...
describe('WISE Setting Up a Run', () => {
  ...
  it('should log in using preview username and password and open the project library', () => {
    ...
    expect(browser.getCurrentUrl()).toEqual(
      'http://localhost:8080/wise/teacher/management/library.html'
    );
  ...
  it('should display the my classroom runs page', () => {
    ...
    expect(browser.getCurrentUrl()).toEqual(
      'http://localhost:8080/wise/teacher/management/classroomruns.html'
    );
    expect(
      element(by.cssContainingText('.runRow .accesscode', newRunCode)).isPresent()
    ).toBeTruthy();
  });
