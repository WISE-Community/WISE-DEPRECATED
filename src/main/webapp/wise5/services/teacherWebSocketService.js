define(['configService'], function(configService) {
    ...
    var service = ['$http', '$rootScope', '$websocket', 'ConfigService', 'StudentDataService', 'StudentStatusService',
                   function($http, $rootScope, $websocket, ConfigService, StudentDataService, StudentStatusService) {
        var serviceObject = {};
