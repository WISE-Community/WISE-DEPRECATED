...
result=componentService.displayAnnotation(component,annotation);if(annotation.data!=null&&annotation.data.isGlobal&&annotation.data.isPopup){result=false;// don't display annotation inline; it will be displayed in a popup
     ...
     */},{key:'getNotificationsByScore',value:function getNotificationsByScore(component,score){var notificationsByScore=[];if(component.notificationSettings!=null&&component.notificationSettings.notifications!=null){var notifications=component.notificationSettings.notifications;for(var n=0;n<notifications.length;n++){var notification=notifications[n];if(notification.enableCriteria!=null&&notification.enableCriteria.score!=null){var enableCriteriaScoreArray=notification.enableCriteria.score;for(var s=0;s<enableCriteriaScoreArray.length;s++){var enableCriteriaScore=enableCriteriaScoreArray[s];if(enableCriteriaScore==score){notificationsByScore.push(notification);}}}}}return notificationsByScore;}/**
