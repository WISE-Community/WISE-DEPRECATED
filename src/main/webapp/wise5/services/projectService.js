...
var ProjectService = function () {
  ...
  _createClass(ProjectService, [{
    ...
    value: function cleanupBeforeSave() {
      ...
      try {
        for (var _iterator24 = activeNodes[Symbol.iterator](), _step24; !(_iteratorNormalCompletion24 = (_step24 = _iterator24.next()).done); _iteratorNormalCompletion24 = true) {
          var activeNode = _step24.value;
      ...
      try {
        for (var _iterator25 = inactiveNodes[Symbol.iterator](), _step25; !(_iteratorNormalCompletion25 = (_step25 = _iterator25.next()).done); _iteratorNormalCompletion25 = true) {
          var inactiveNode = _step25.value;
    ...
    value: function cleanupNode(node) {
      ...
      if (components != null) {
        ...
        try {
          for (var _iterator26 = components[Symbol.iterator](), _step26; !(_iteratorNormalCompletion26 = (_step26 = _iterator26.next()).done); _iteratorNormalCompletion26 = true) {
            var component = _step26.value;
          ...
          if (transitions != null) {
            ...
            if (transitions.length === 0) {
              ...
              if (parentGroupTransitions != null) {
                ...
                try {
                  for (var _iterator27 = parentGroupTransitions[Symbol.iterator](), _step27; !(_iteratorNormalCompletion27 = (_step27 = _iterator27.next()).done); _iteratorNormalCompletion27 = true) {
                    var parentGroupTransition = _step27.value;
                    ...
                    if (parentGroupTransition != null) {
                      ...
                      if (pathSoFar.indexOf(toNodeId) == -1) {
                        ...
                        try {
                          for (var _iterator28 = allPathsFromToNode[Symbol.iterator](), _step28; !(_iteratorNormalCompletion28 = (_step28 = _iterator28.next()).done); _iteratorNormalCompletion28 = true) {
                            var tempPath = _step28.value;
              ...
              try {
                for (var _iterator29 = transitions[Symbol.iterator](), _step29; !(_iteratorNormalCompletion29 = (_step29 = _iterator29.next()).done); _iteratorNormalCompletion29 = true) {
                  var transition = _step29.value;
                  ...
                  if (transition != null) {
                    ...
                    if (_toNodeId != null && pathSoFar.indexOf(_toNodeId) == -1) {
                      ...
                      if (_allPathsFromToNode != null) {
                        ...
                        try {
                          for (var _iterator30 = _allPathsFromToNode[Symbol.iterator](), _step30; !(_iteratorNormalCompletion30 = (_step30 = _iterator30.next()).done); _iteratorNormalCompletion30 = true) {
                            var _tempPath = _step30.value;
            ...
            if (includeGroups) {
              if (pathSoFar.length == 1) {
                ...
                try {
                  for (var _iterator31 = allPaths[Symbol.iterator](), _step31; !(_iteratorNormalCompletion31 = (_step31 = _iterator31.next()).done); _iteratorNormalCompletion31 = true) {
                    var _path = _step31.value;
          ...
          if (groupNode != null) {
            ...
            if (startId == null || startId == "") {
              ...
              if (_transitions != null && _transitions.length > 0) {
                ...
                try {
                  for (var _iterator32 = _transitions[Symbol.iterator](), _step32; !(_iteratorNormalCompletion32 = (_step32 = _iterator32.next()).done); _iteratorNormalCompletion32 = true) {
                    var _transition = _step32.value;
                    ...
                    if (_transition != null) {
                      ...
                      if (_allPathsFromToNode2 != null) {
                        ...
                        try {
                          for (var _iterator33 = _allPathsFromToNode2[Symbol.iterator](), _step33; !(_iteratorNormalCompletion33 = (_step33 = _iterator33.next()).done); _iteratorNormalCompletion33 = true) {
                            var _tempPath2 = _step33.value;
              ...
              if (_allPathsFromToNode3 != null) {
                ...
                try {
                  for (var _iterator34 = _allPathsFromToNode3[Symbol.iterator](), _step34; !(_iteratorNormalCompletion34 = (_step34 = _iterator34.next()).done); _iteratorNormalCompletion34 = true) {
                    var _tempPath4 = _step34.value;
      ...
      try {
        for (var _iterator35 = paths[Symbol.iterator](), _step35; !(_iteratorNormalCompletion35 = (_step35 = _iterator35.next()).done); _iteratorNormalCompletion35 = true) {
          ...
          if (path.includes(nodeId)) {
            ...
            try {
              for (var _iterator36 = subPath[Symbol.iterator](), _step36; !(_iteratorNormalCompletion36 = (_step36 = _iterator36.next()).done); _iteratorNormalCompletion36 = true) {
                var nodeIdInPath = _step36.value;
    ...
    value: function updateBranchPathTakenConstraint(node, currentFromNodeId, currentToNodeId, newFromNodeId, newToNodeId) {
      ...
      try {
        for (var _iterator56 = node.constraints[Symbol.iterator](), _step56; !(_iteratorNormalCompletion56 = (_step56 = _iterator56.next()).done); _iteratorNormalCompletion56 = true) {
          var constraint = _step56.value;
          var _iteratorNormalCompletion57 = true;
          var _didIteratorError57 = false;
          var _iteratorError57 = undefined;

          try {
            for (var _iterator57 = constraint.removalCriteria[Symbol.iterator](), _step57; !(_iteratorNormalCompletion57 = (_step57 = _iterator57.next()).done); _iteratorNormalCompletion57 = true) {
              var removalCriterion = _step57.value;
    ...
    value: function inheritParentTransitions(nodeIdToInsertInside, nodeToInsert) {
      ...
      try {
        for (var _iterator58 = parentTransitions[Symbol.iterator](), _step58; !(_iteratorNormalCompletion58 = (_step58 = _iterator58.next()).done); _iteratorNormalCompletion58 = true) {
          var parentTransition = _step58.value;
    ...
    value: function updateTransitionsToStartId(startId, nodeIdToInsert) {
      ...
      try {
        for (var _iterator60 = nodesThatTransitionToStartId[Symbol.iterator](), _step60; !(_iteratorNormalCompletion60 = (_step60 = _iterator60.next()).done); _iteratorNormalCompletion60 = true) {
          var nodeThatTransitionToStartId = _step60.value;
    ...
    value: function containsStartNodeId(groupId) {
      ...
      try {
        for (var _iterator73 = group.ids[Symbol.iterator](), _step73; !(_iteratorNormalCompletion73 = (_step73 = _iterator73.next()).done); _iteratorNormalCompletion73 = true) {
          var childId = _step73.value;
    ...
    value: function removeNodeIdFromGroups(nodeId) {
      ...
      try {
        for (var _iterator81 = this.getGroupNodes()[Symbol.iterator](), _step81; !(_iteratorNormalCompletion81 = (_step81 = _iterator81.next()).done); _iteratorNormalCompletion81 = true) {
      ...
      try {
        for (var _iterator82 = this.getInactiveGroupNodes()[Symbol.iterator](), _step82; !(_iteratorNormalCompletion82 = (_step82 = _iterator82.next()).done); _iteratorNormalCompletion82 = true) {
    ...
    value: function doesAnyComponentInNodeShowSubmitButton(nodeId) {
      ...
      try {
        for (var _iterator84 = node.components[Symbol.iterator](), _step84; !(_iteratorNormalCompletion84 = (_step84 = _iterator84.next()).done); _iteratorNormalCompletion84 = true) {
