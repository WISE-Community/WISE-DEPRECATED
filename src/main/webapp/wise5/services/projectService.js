...
var ProjectService = function () {
  ...
  _createClass(ProjectService, [{
        ...
        if (parentGroupStartId != null) {
          if (parentGroupStartId === nodeId) {
            ...
            if (nodeToRemoveTransitions != null && nodeToRemoveTransitions.length > 0) {
              ...
              try {
                for (var _iterator70 = nodeToRemoveTransitions[Symbol.iterator](), _step70; !(_iteratorNormalCompletion70 = (_step70 = _iterator70.next()).done); _iteratorNormalCompletion70 = true) {
                  var nodeToRemoveTransition = _step70.value;
              ...
              if (nodeId === transition.to) {
                ...
                if (this.isFirstNodeInBranchPath(nodeId)) {
                  ...
                  if (nodeIdsInBranch != null) {
                    ...
                    try {
                      for (var _iterator71 = nodeIdsInBranch[Symbol.iterator](), _step71; !(_iteratorNormalCompletion71 = (_step71 = _iterator71.next()).done); _iteratorNormalCompletion71 = true) {
                        var nodeIdInBranch = _step71.value;
                        ...
                        try {
                          for (var _iterator72 = transitionsCopy[Symbol.iterator](), _step72; !(_iteratorNormalCompletion72 = (_step72 = _iterator72.next()).done); _iteratorNormalCompletion72 = true) {
                            var transitionCopy = _step72.value;
                  ...
                  try {
                    for (var _iterator73 = branches[Symbol.iterator](), _step73; !(_iteratorNormalCompletion73 = (_step73 = _iterator73.next()).done); _iteratorNormalCompletion73 = true) {
                      var branch = _step73.value;
                      ...
                      if (branch != null) {
                        ...
                        if (branchPaths != null) {
                          ...
                          try {
                            for (var _iterator74 = branchPaths[Symbol.iterator](), _step74; !(_iteratorNormalCompletion74 = (_step74 = _iterator74.next()).done); _iteratorNormalCompletion74 = true) {
                              var branchPath = _step74.value;
                              ...
                              if (branchPath != null) {
                                ...
                                try {
                                  for (var _iterator75 = branchPath[Symbol.iterator](), _step75; !(_iteratorNormalCompletion75 = (_step75 = _iterator75.next()).done); _iteratorNormalCompletion75 = true) {
                                    var branchPathNodeId = _step75.value;
                ...
                if (transitionsCopy != null) {
                  ...
                  try {
                    for (var _iterator76 = transitionsCopy[Symbol.iterator](), _step76; !(_iteratorNormalCompletion76 = (_step76 = _iterator76.next()).done); _iteratorNormalCompletion76 = true) {
                      var _transitionCopy = _step76.value;
    ...
    value: function removeNodeIdFromGroups(nodeId) {
      ...
      try {
        for (var _iterator77 = this.getGroupNodes()[Symbol.iterator](), _step77; !(_iteratorNormalCompletion77 = (_step77 = _iterator77.next()).done); _iteratorNormalCompletion77 = true) {
      ...
      try {
        for (var _iterator78 = this.getInactiveGroupNodes()[Symbol.iterator](), _step78; !(_iteratorNormalCompletion78 = (_step78 = _iterator78.next()).done); _iteratorNormalCompletion78 = true) {
          var inactiveGroup = _step78.value;
    ...
    value: function doesAnyComponentHaveWork(nodeId) {
      ...
      try {
        for (var _iterator79 = node.components[Symbol.iterator](), _step79; !(_iteratorNormalCompletion79 = (_step79 = _iterator79.next()).done); _iteratorNormalCompletion79 = true) {
          var component = _step79.value;
    ...
    value: function doesAnyComponentShowSaveButton(nodeId) {
      ...
      if (node != null) {
        ...
        if (components != null) {
          ...
          try {
            for (var _iterator80 = components[Symbol.iterator](), _step80; !(_iteratorNormalCompletion80 = (_step80 = _iterator80.next()).done); _iteratorNormalCompletion80 = true) {
    ...
    value: function doesAnyComponentShowSubmitButton(nodeId) {
      ...
      if (node != null) {
        ...
        if (components != null) {
          ...
          try {
            for (var _iterator81 = components[Symbol.iterator](), _step81; !(_iteratorNormalCompletion81 = (_step81 = _iterator81.next()).done); _iteratorNormalCompletion81 = true) {
