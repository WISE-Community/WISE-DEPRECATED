...
describe('DrawService', () => {
  ...
  shouldCheckThatTheComponentIsNotCompleted();
  shouldCheckThatTheComponentIsCompleted();
  shouldCheckThatTheComponentStateDoesNotHaveStudentWwork();
  shouldCheckThatTheComponentStateHasStudentWork();
});
...
function shouldCheckThatTheComponentIsNotCompleted() {
...
function shouldCheckThatTheComponentIsCompleted() {
  it('should check that the component is completed', () => {
    ...
    const isCompleted = DrawService.isCompleted(
      component,
      componentStates,
      componentEvents,
      nodeEvents,
...
function shouldCheckThatTheComponentStateDoesNotHaveStudentWwork() {
  it('should check that the component state does not have student work', () => {
    const componentState = {
      studentData: {
        drawData:
          '{"version":1,"dt":{"width":800,"height":600},"canvas":{"objects":[],"background":"#fff","backgroundImage":{"type":"image","originX":"center","originY":"center","left":400,"top":300,"width":1200,"height":800,"fill":"rgb(0,0,0)","stroke":null,"strokeWidth":0,"strokeDashArray":null,"strokeLineCap":"butt","strokeLineJoin":"miter","strokeMiterLimit":10,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":null,"visible":true,"clipTo":null,"backgroundColor":"","fillRule":"nonzero","globalCompositeOperation":"source-over","transformMatrix":null,"skewX":0,"skewY":0,"crossOrigin":"anonymous","alignX":"none","alignY":"none","meetOrSlice":"meet","lockUniScaling":false,"src":"http://localhost:8080/curriculum/10/assets/background.jpg","filters":[],"resizeFilters":[]}}}'
      }
    };
    const componentContent = {};
    const hasStudentWork = DrawService.componentStateHasStudentWork(
      componentState,
      componentContent
    );
...
function shouldCheckThatTheComponentStateHasStudentWork() {
