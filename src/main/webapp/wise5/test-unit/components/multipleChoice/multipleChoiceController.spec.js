...
describe('MultipleChoiceController', function () {
  ...
  it('single answer single correct answer component should show incorrect when no answer is submitted', function () {
    loadSingleAnswerSingleCorrectAnswerComponent();
    checkAnswer();
  ...
  it('multiple answer component should show incorrect when no answers are submitted', function () {
    loadMultipleAnswerComponent();
    checkAnswer();
    expect(multipleChoiceController.isCorrect).toBeFalsy();
  });
