...
describe('ProjectService Unit Test', () => {
  ...
  describe('ProjectService', () => {
    ...
    it('should get the component by node id and component id', () => {
      ProjectService.setProject(scootersProjectJSON);
      // nodeId is null
      const nullNodeIdResult = ProjectService.getComponentByNodeIdAndComponentId(
        null,
        '57lxhwfp5r'
      );
      ...
      // componentId is null
      const nullComponentIdResult = ProjectService.getComponentByNodeIdAndComponentId(
        'node13',
        null
      );
