...
describe('NodeService', () => {
  ...
  beforeEach(inject(function(_NodeService_, _ProjectService_, _StudentDataService_, _$q_) {
...
function moveComponent_MoveOneComponentToBeginning() {
  it('should move one component to the beginning of the node', () => {
    expect(
      ProjectService.getComponentPositionByNodeIdAndComponentId('node10', 'cjv5kq5290')
    ).toEqual(4);
    expect(
      ProjectService.getComponentPositionByNodeIdAndComponentId('node10', 'm97kyu4d4v')
    ).toEqual(0);
...
function moveComponent_MoveMultipleComponentsToBeginning() {
  it('should move multiple components to the beginning of the node', () => {
    expect(
      ProjectService.getComponentPositionByNodeIdAndComponentId('node10', '2upmb3om1q')
    ).toEqual(2);
    expect(
      ProjectService.getComponentPositionByNodeIdAndComponentId('node10', 'cjv5kq5290')
    ).toEqual(4);
