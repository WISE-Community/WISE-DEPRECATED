...
describe('SessionService', () => {
  ...
  describe('calculateIntervals()', () => {
    shouldCalculateTheWarnAndLogoutIntervalsWhenSessionTimeoutIs10Minutes();
    shouldCalculateTheWarnAndLogoutIntervalsWhenSessionTimeoutIs30Minutes();
    shouldCalculateTheWarnAndLogoutIntervalsWhenSessionTimeoutIs60Minutes();
  });
});

function shouldCalculateTheWarnAndLogoutIntervalsWhenSessionTimeoutIs10Minutes() {
...
function shouldCalculateTheWarnAndLogoutIntervalsWhenSessionTimeoutIs30Minutes() {
...
function shouldCalculateTheWarnAndLogoutIntervalsWhenSessionTimeoutIs60Minutes() {
