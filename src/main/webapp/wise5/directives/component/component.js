...
var ComponentController = function ComponentController($injector, $scope, $compile, $element, ConfigService, NodeService, NotebookService, ProjectService, StudentDataService, UtilService) {
    ...
    if ($scope.mode === 'authoring' && (componentContent.type == 'Animation' || componentContent.type == 'ConceptMap' || componentContent.type == 'Discussion' || componentContent.type == 'Draw' || componentContent.type == 'Graph' || componentContent.type == 'HTML' || componentContent.type == 'Label' || componentContent.type == 'Match')) {
