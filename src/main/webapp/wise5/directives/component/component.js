class ComponentController {
  ...
  $onInit() {
    ...
    var authoringComponentContent = this.ProjectService.getComponentByNodeIdAndComponentId(
      this.nodeId,
      this.componentId
    );
    ...
    if (this.$scope.mode === 'authoring') {
      ...
      this.$scope.componentTemplatePath = this.NodeService.getComponentAuthoringTemplatePath(
