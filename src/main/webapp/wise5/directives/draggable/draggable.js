...
class DraggableController {
  ...
  mousemove(event) {
     ...
     */
    var overlayWidth = this.$element
      .scope()
      .$eval(this.$element[0].attributes['container-width'].value);
    var overlayHeight = this.$element
      .scope()
      .$eval(this.$element[0].attributes['container-height'].value);
