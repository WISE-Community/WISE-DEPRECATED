    ...
    _createClass(EditNotebookItemController, [{
        ...
        value: function save() {
            ...
            this.$q.all(uploadAssetPromises).then(function () {
                _this2.NotebookService.saveNotebookItem(_this2.item.id, _this2.item.nodeId, _this2.item.localNotebookItemId, _this2.item.type, _this2.item.title, _this2.item.content).then(function () {
