...
//'ui.tinymce',
'ui.tree']).service(_annotationService2.default.name, _annotationService2.default).service(_audioPlayerService2.default.name, _audioPlayerService2.default)
