...
import { OutsideURLModule } from '../components/outsideURL/outside-url.module';
...
import { OutsideURL } from '../components/outsideURL/outside-url.component';
...
export default angular.module('vle', [
  ...
  .directive('outside-url', downgradeComponent({component: OutsideURL} as angular.IDirectiveFactory))
