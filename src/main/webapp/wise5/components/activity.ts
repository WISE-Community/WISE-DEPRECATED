...
export class Activity {
  ...
  workgroupId;
  teacherWorkgroupId;
  showAddToNotebookButton;
  latestAnnotations;
  summernoteRubricId;
  summernoteRubricHTML;
  summernoteRubricOptions;
  allowedConnectedComponentTypes;
  authoringComponentContentJSONString;
  isJSONStringChanged;
  authoringValidComponentContentJSONString;
