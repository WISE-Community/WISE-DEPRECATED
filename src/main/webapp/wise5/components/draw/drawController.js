...
var _drawingTool2 = _interopRequireDefault(require("../../lib/drawingTool/drawing-tool"));
...
function (_ComponentController) {
  ...
  function DrawController($filter, $injector, $mdDialog, $q, $rootScope, $scope, $timeout, AnnotationService, ConfigService, DrawService, NodeService, NotebookService, ProjectService, StudentAssetService, StudentDataService, UtilService) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(DrawController).call(this, $filter, $mdDialog, $rootScope, $scope, AnnotationService, ConfigService, NodeService, NotebookService, ProjectService, StudentAssetService, StudentDataService, UtilService));
    ...
    _this.$timeout(angular.bind(_assertThisInitialized(_this), _this.initializeDrawingTool));
  ...
  _createClass(DrawController, [{
    ...
    value: function setupTools() {
      ...
      if (tools == null) {// we will display all the tools
      } else {
