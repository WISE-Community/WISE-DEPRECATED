...
var GraphController = function () {
    function GraphController($injector, $q, $rootScope, $scope, $timeout, ConfigService, GraphService, NodeService, NotebookService, ProjectService, StudentAssetService, StudentDataService, UtilService) {
        var _this = this;
...
GraphController.$inject = ['$injector', '$q', '$rootScope', '$scope', '$timeout', 'ConfigService', 'GraphService', 'NodeService', 'NotebookService', 'ProjectService', 'StudentAssetService', 'StudentDataService', 'UtilService'];
