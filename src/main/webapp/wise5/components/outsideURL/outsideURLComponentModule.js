...
var outsideURLComponentModule = angular.module('outsideURLComponentModule', []).service(_outsideURLService2.default.name, _outsideURLService2.default).controller(_outsideURLController2.default.name, _outsideURLController2.default);
