...
var htmlComponentModule = angular.module('htmlComponentModule', []).service(_htmlService2.default.name, _htmlService2.default).controller(_htmlController2.default.name, _htmlController2.default);
