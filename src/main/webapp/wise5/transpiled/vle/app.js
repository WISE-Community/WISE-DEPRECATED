...
define(['angular', 'bootstrap', 'd3', 'directives', 'filters', 'jquery', 'jqueryUI', 'angularAnimate', 'angularAria', 'angularMaterial', 'angularAudio', 'angularDragDrop', 'angularFileUpload', 'angularMoment', 'angularSortable', 'angularSanitize', 'angularToArrayFilter', 'angularUIRouter', 'angularUITinymce', 'angularUITree', 'angularWebSocket', 'annotationService', 'audioRecorderService', 'configService', 'cRaterService', 'discussionService', 'drawService', 'embeddedService', 'graphService', 'highcharts-ng', 'htmlService', 'labelService', 'matchService', 'moment', 'multipleChoiceService', 'nodeService', 'ocLazyLoad', 'openResponseService', 'outsideURLService', 'photoBoothService', 'notebookService', 'notebook', 'projectService', 'sessionService', 'studentAssetService', 'studentDataService', 'studentStatusService', 'studentWebSocketService', 'tableService', 'teacherDataService', 'tinymce', 'utilService', 'webfont', 'webfonts'], function (angular, bootstrap, d3, directives, filters, $, jqueryUI, angularAnimate, angularAria, angularMaterial, angularAudio, angularDragDrop, angularFileUpload, angularMoment, angularSortable, angularSanitize, angularToArrayFilter, angularUIRouter, angularUITinymce, angularUITree, angularWebSocket, annotationService, audioRecorderService, configService, cRaterService, discussionService, drawService, embeddedService, graphService, highchartsng, htmlService, labelService, matchService, moment, multipleChoiceService, nodeService, ocLazyLoad, openResponseService, outsideURLService, photoBoothService, notebookService, notebook, projectService, sessionService, studentAssetService, studentDataService, studentStatusService, studentWebSocketService, tableService, teacherDataService, tinymce, utilService, webfont, webfonts) {

    var app = angular.module('app', ['angularMoment', 'angular-toArrayFilter', 'directives', 'filters', 'highcharts-ng', 'ngAnimate', 'ngAudio', 'ngAria', 'ngDragDrop', 'ngFileUpload', 'ngMaterial', 'ngSanitize', 'ngWebSocket', 'notebook', 'oc.lazyLoad', 'ui.router', 'ui.sortable', 'ui.tinymce', 'ui.tree']);
    ...
    app.config(['$urlRouterProvider', '$stateProvider', '$compileProvider', '$controllerProvider', '$mdThemingProvider', '$ocLazyLoadProvider', function ($urlRouterProvider, $stateProvider, $compileProvider, $controllerProvider, $mdThemingProvider, $ocLazyLoadProvider) {
