...
define(['angular', 'configService', 'openResponseService', 'notebookService', 'projectService', 'sessionService', 'studentAssetService', 'studentDataService'], function (angular, configService, openResponseService, notebookService, projectService, sessionService, studentAssetService, studentDataService) {

    angular.module('notebook', []).directive('notebook', function () {
        return {
            scope: {
                filter: '=',
                templateUrl: '=',
    ...
    }).controller('NotebookController', function ($injector, $rootScope, $scope, $state, $stateParams, ConfigService, OpenResponseService, NotebookService, ProjectService, SessionService, StudentAssetService, StudentDataService) {
