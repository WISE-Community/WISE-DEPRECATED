...
define(['app'], function (app) {
    ...
    app.$controllerProvider.register('NodeProgressController', ['$scope', '$state', 'ConfigService', 'ProjectService', 'StudentStatusService', 'TeacherDataService', function ($scope, $state, ConfigService, ProjectService, StudentStatusService, TeacherDataService) {
