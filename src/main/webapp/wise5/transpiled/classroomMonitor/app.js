...
define(['angular', 'bootstrap', 'd3', 'directives', 'filters', 'jquery', 'jqueryUI', 'angularAnimate', 'angularAria', 'angularMaterial', 'angularAudio', 'angularDragDrop', 'angularFileUpload', 'angularMoment', 'angularSortable', 'angularSanitize', 'angularToArrayFilter', 'angularUIRouter', 'angularUITinymce', 'angularUITree', 'angularWebSocket', 'annotationService', 'audioRecorderService', 'configService', 'cRaterService', 'discussionService', 'drawService', 'embeddedService', 'graphService', 'highcharts-ng', 'htmlService', 'labelService', 'matchService', 'moment', 'multipleChoiceService', 'nodeService', 'openResponseService', 'outsideURLService', 'photoBoothService', 'notebookService', 'notebook', 'projectService', 'sessionService', 'studentAssetService', 'studentDataService', 'studentStatusService', 'studentWebSocketService', 'tableService', 'teacherDataService', 'teacherWebSocketService', 'tinymce', 'utilService', 'webfont', 'webfonts'], function (angular, bootstrap, d3, directives, filters, $, jqueryUI, angularAnimate, angularAria, angularMaterial, angularAudio, angularDragDrop, angularFileUpload, angularMoment, angularSortable, angularSanitize, angularToArrayFilter, angularUIRouter, angularUITinymce, angularUITree, angularWebSocket, annotationService, audioRecorderService, configService, cRaterService, discussionService, drawService, embeddedService, graphService, highchartsng, htmlService, labelService, matchService, moment, multipleChoiceService, nodeService, openResponseService, outsideURLService, photoBoothService, notebookService, notebook, projectService, sessionService, studentAssetService, studentDataService, studentStatusService, studentWebSocketService, tableService, teacherDataService, teacherWebSocketService, tinymce, utilService, webfont, webfonts) {

    var app = angular.module('app', ['angular-toArrayFilter', 'angularMoment', 'directives', 'filters', 'highcharts-ng', 'ngAnimate', 'ngDragDrop', 'ngFileUpload', 'ngMaterial', 'ngSanitize', 'ngWebSocket', 'ui.router', 'ui.sortable']);
    ...
    app.config(['$compileProvider', '$controllerProvider', '$mdThemingProvider', '$stateProvider', '$urlRouterProvider', function ($compileProvider, $controllerProvider, $mdThemingProvider, $stateProvider, $urlRouterProvider) {
