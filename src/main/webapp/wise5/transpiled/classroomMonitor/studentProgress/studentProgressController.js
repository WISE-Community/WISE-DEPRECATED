...
define(['app'], function (app) {
    ...
    app.$controllerProvider.register('StudentProgressController', ['$rootScope', '$state', 'ConfigService', 'StudentStatusService', 'TeacherDataService', 'TeacherWebSocketService', function ($rootScope, $state, ConfigService, StudentStatusService, TeacherDataService, TeacherWebSocketService) {
