...
define(['app'], function (app) {
    app.$controllerProvider.register('CRaterController', function ($rootScope, $scope, $state, $stateParams, ConfigService, NodeService, CRaterService, ProjectService, SessionService, StudentDataService) {
        ...
        this.makeCRaterRequest = function (studentData) {
            ...
            if (componentContent != null) {
                ...
                CRaterService.makeCRaterRequest(cRaterItemType, cRaterItemId, cRaterRequestType, cRaterResponseId, studentData).then(angular.bind(this, function (response) {
        ...
        this.handleCRaterResponse = function (response) {
            ...
            this.unSavedAnnotation = StudentDataService.createAnnotation(annotationId, runId, periodId, fromWorkgroupId, toWorkgroupId, nodeId, componentId, componentStateId, annotationType, data, clientSaveTime);
