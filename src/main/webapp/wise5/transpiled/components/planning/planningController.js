...
define(['app'], function (app) {
    app.$controllerProvider.register('PlanningController', function ($rootScope, $scope, $state, $stateParams, ConfigService, NodeService, OpenResponseService, ProjectService, StudentDataService) {
