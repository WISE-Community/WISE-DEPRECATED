...
define(['app'], function (app) {
    app.$controllerProvider.register('PhotoBoothController', function ($rootScope, $scope, $state, $stateParams, ConfigService, NodeService, PhotoBoothService, ProjectService, SessionService, StudentAssetService, StudentDataService) {
        ...
        this.connect = function (stream) {
            ...
            }), 1000); // wait for video stream to display
        };
