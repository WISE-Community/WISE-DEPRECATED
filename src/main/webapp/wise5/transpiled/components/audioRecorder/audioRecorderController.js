...
define(['app'], function (app) {
    app.$controllerProvider.register('AudioRecorderController', function ($scope, $rootScope, $state, $stateParams, AudioRecorderService, ConfigService, NodeService, ProjectService, SessionService, StudentAssetService, StudentDataService) {
