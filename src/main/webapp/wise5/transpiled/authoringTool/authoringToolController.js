...
define(['app'], function (app) {
    app.$controllerProvider.register('AuthoringToolController', function ($scope, $rootScope, $state, $stateParams, ConfigService, NotebookService, ProjectService, NodeService, SessionService, TeacherDataService, $mdDialog) {
