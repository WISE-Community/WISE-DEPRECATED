...
/*#__PURE__*/
function () {
  function NodeInfoController(ProjectService, SummaryService, TeacherDataService, UtilService) {
    var _this = this;
  ...
  _createClass(NodeInfoController, [{
    ...
    key: "isSummaryAvailable",
    value: function isSummaryAvailable(componentType) {
...
NodeInfoController.$inject = ['ProjectService', 'SummaryService', 'TeacherDataService', 'UtilService'];
var NodeInfo = {
  bindings: {
    nodeId: '@'
  },
