    ...
    _createClass(DataExportController, [{
        ...
        value: function exportStudentWork(exportType) {
            ...
            this.TeacherDataService.getExport("allStudentWork").then(function (result) {
                ...
                var workgroups = _this2.ConfigService.getClassmateUserInfos();
                ...
                var columnNames = ["#", "Workgroup ID", "WISE ID 1", "WISE ID 2", "WISE ID 3", "Class Period", "Project ID", "Project Name", "Run ID", "Start Date", "End Date", "Student Work ID", "Timestamp", "Node ID", "Component ID", "Component Part Number", "Teacher Score Timestamp", "Teacher Score", "Max Teacher Score", "Teacher Comment Timestamp", "Teacher Comment", "Auto Score Timestamp", "Auto Score", "Max Auto Score", "Auto Comment Timestamp", "Auto Comment", "Step Title", "Component Type", "Component Prompt", "Student Data", "Component Revision Count", "Is Correct", "Is Submit", "Submit Count", "Response"];
                                ...
                                for (var c = 0; c < componentStates.length; c++) {
                                    ...
                                    if (componentState != null) {
                                        ...
                                        if (exportRow) {
                                            ...
                                            var row = _this2.createStudentWorkExportRow(columnNames, columnNameToNumber, rowCounter, workgroupId, wiseId1, wiseId2, wiseId3, periodName, componentRevisionCount, componentState);
        ...
        value: function createStudentWorkExportRow(columnNames, columnNameToNumber, rowCounter, workgroupId, wiseId1, wiseId2, wiseId3, periodName, componentRevisionCount, componentState) {
            ...
            this.TeacherDataService.getExport(exportType).then(function (result) {
                ...
                for (var rowIndex = 0; rowIndex < result.length; rowIndex++) {
                    ...
                    if (rowIndex === 0) {
                        ...
                        if (row[COLUMN_INDEX_TYPE] === "report") {
                            if (studentDataJSONCell.content != null) {
                                row[COLUMN_INDEX_STUDENT_RESPONSE] = _this4.escapeContent(studentDataJSONCell.content);
                            } else {
                                row[COLUMN_INDEX_STUDENT_RESPONSE] = "";
                            }
                        } else if (row[COLUMN_INDEX_TYPE] === "note") {
                            if (studentDataJSONCell.text != null) {
                                row[COLUMN_INDEX_STUDENT_RESPONSE] = _this4.escapeContent(studentDataJSONCell.text);
                            } else {
                                row[COLUMN_INDEX_STUDENT_RESPONSE] = "";
                            }
                        }
