    ...
    value: function calculateNodeOrder(node) {
      ...
      if (this.isGroupNode(node.id)) {
        ...
        if (planningIds) {
          ...
          try {
            for (var _iterator3 = planningIds[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
              var planningId = _step3.value;
