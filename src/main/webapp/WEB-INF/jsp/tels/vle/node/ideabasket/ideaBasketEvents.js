 ...
 * quizDispatcher
 */
View.prototype.ideaBasketDispatcher = function(type,args,obj){
	/*
	 ...
	 */ 
	if(type == 'ideaBasketUpdatePrompt') {
		/*
		 ...
		 * wait until you implement the authoring before you rename this 
		 */
		obj.IdeaBasketNode.updatePrompt();
	}
};
...
for(var x=0; x<events.length; x++) {
	 ...
	 */
	componentloader.addEvent(events[x], 'ideaBasketDispatcher');
};
...
if(typeof eventManager != 'undefined'){
	 ...
	 */
	eventManager.fire('scriptLoaded', 'vle/node/ideabasket/ideaBasketEvents.js');
};