define(['app','jquery'], function(app,$) {
    app.$controllerProvider.register('StudentViewController', function() {
        ...
        function receiveMessage(event) {
            ...
            console.log('in student view controller, received message: '+event.data+" which is: "+JSON.stringify(event.data));
            ...
            if (msg.messageType == "requestStepContentAndStateAndAnnotationFromWISE") {
                ...
                nodeIFrameOR.contentWindow.postMessage({"viewType":"student","content":{"title":"open response step 1","prompt":prompt,"style":"#title {color:pink}"},"globalStyle":"#title {color:purple;} body {background-color:yellow}","stepState":{"response":"my name is bob"}}, "http://10.0.1.4");
        ...
        //$("#node").html('<iframe id="nodeIFrameOR" width="400px" height="600px" src="http://10.0.1.4/nodes/openResponse/index.html"></iframe>');
        //$("#node").html('<iframe id="nodeIFrameEcho" width="400px" height="600px" src="http://wise4.org/echo/index.html"></iframe>');
        $("#navigation").html('<iframe id="navigationIFrame" width="400px" height="600px" src="http://wise4.org/navigation/index.html"></iframe>');
