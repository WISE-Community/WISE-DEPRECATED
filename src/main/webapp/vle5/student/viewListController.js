define(['app', 'jquery', 'configService', 'nodeApplicationService', 'projectService', 'nodeService'], 
    ...
    app.$controllerProvider.register('ViewListController', function(ConfigService, NodeApplicationService, ProjectService, NodeService) {
        ...
        $('#navigation').html('<iframe id="navigationIFrame" '+ 
                'src="http://localhost:8080/wise/navigation/navigationList/index.html"></iframe>');
    });
});