							  ...
							  <tr id="runTitleRow_${run.id}" class="runRow">
							    ...
							    <td>
								   <ul class="actionList">
	                  					...
	                  					<a id='linkToSeeOldGradingTools' onclick="$('#oldGradingTools').show();$('#linkToSeeOldGradingTools').hide();">(click here to access old grading tools)</a>
	                  					<span id="oldGradingTools" style="display:none">
