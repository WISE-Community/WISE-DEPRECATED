								...
								<tr id="runTitleRow_${run.id}" class="runRow">
									...
									<td>
										...
										<ul class="actionList">
											...
											<li><a href="${contextPath}/legacy/contact/contactwise.html?projectId=${run.project.id}&runId=${run.id}"><img class="icon" alt="contact" src="${contextPath}/<spring:theme code="email"/>" /><span><spring:message code="teacher.management.projectruntabs.reportProblem"/></span></a></li>
											<sec:accesscontrollist domainObject="${run}" hasPermission="16">
