...
<head>
    ...
    <br/>
    <span>WISE4 Project File Path: </span><input id="projectFilePathInput" type="text" size="100" value="http://localhost:8080/curriculum/14235-1439924334197/wise4.project.json"/> <button onclick="convert()">Convert</button>
    <br/>
    <br/>
