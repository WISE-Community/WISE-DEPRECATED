...
(function($){
  ...
  showSelector = function(){
    ...
    selector.css({
		...
		top: $(selectorOwner).offset().top - ($(selector).outerHeight()) + ($(selectorOwner).outerHeight()), // wise4 edit
		//left: $(selectorOwner).offset().left
		left: $(selectorOwner).offset().left + ($(selectorOwner).outerWidth()) // wise4 edit
    });
...
if(typeof eventManager != 'undefined'){
	eventManager.fire('scriptLoaded', 'vle/node/draw/svg-edit/extensions/jquery-rscp/jquery.colorPicker.js');
};