 ...
 * @constructor
 */
function EpigameState(response) {
 ...
 * @return a EpigameState object
 */
EpigameState.prototype.parseDataJSONObj = function(stateJSONObj) {
	//obtain the student work from the JSONObject
	var response = stateJSONObj.response;
	
	//create a state object with the student work
	var epigameState = new EpigameState(response);
 ...
 */
EpigameState.prototype.getStudentWork = function() {
...
if(typeof eventManager != 'undefined'){
	eventManager.fire('scriptLoaded', 'vle/node/epigame/epigameState.js');
}