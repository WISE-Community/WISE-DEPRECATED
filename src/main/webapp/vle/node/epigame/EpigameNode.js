...
//			this.defaultQuizContent = createContent("node/epigame/adaptiveQuizData.json");
			...
			this.defaultQuizContent = createContent(this.view.getConfig().getConfigParam('projectBaseURL')+"/assets/adaptiveQuizData.json");
//		}
...
//		}
		...
		console.log("Loading:" + this.view.getConfig().getConfigParam('projectBaseURL')+"/assets/adaptiveMissionData.json");
		this.defaultAdaptiveMissionContent = createContent(this.view.getConfig().getConfigParam('projectBaseURL')+"/assets/adaptiveMissionData.json");
