/**
 * Sets the HighchartsTestNode type as an object of this view
 * 
 * TODO: rename HighchartsTestNode
 * 
 * @constructor
 */
View.prototype.HighchartsTestNode = {};
 ...
 * TODO: rename HighchartsTestNode
 */
View.prototype.HighchartsTestNode.commonComponents = [];
 ...
 * TODO: rename HighchartsTestNode
 */
View.prototype.HighchartsTestNode.generatePage = function(view){
	this.view = view;
	 ...
	 * 
	 * onkeyup will fire the 'highchartsTestUpdatePrompt' event which will
	 ...
	 */
	var promptTextArea = createElement(document, 'textarea', {id: 'promptTextArea', rows:'20', cols:'85', onkeyup:"eventManager.fire('highchartsTestUpdatePrompt')"});
 ...
 * TODO: rename HighchartsTestNode
 */
View.prototype.HighchartsTestNode.getCommonComponents = function() {
 ...
 * TODO: rename HighchartsTestNode
 */
View.prototype.HighchartsTestNode.updateContent = function(){
 ...
 * TODO: rename HighchartsTestNode
 */
View.prototype.HighchartsTestNode.populatePrompt = function() {
 ...
 * TODO: rename HighchartsTestNode
 */
View.prototype.HighchartsTestNode.updatePrompt = function(){
	/* update content */
...
if(typeof eventManager != 'undefined'){
	 ...
	 * TODO: rename authorview_highchartsTest
	 * 
	 * e.g. if you were creating a quiz step it would look like
	 * 
	 * eventManager.fire('scriptLoaded', 'vle/node/quiz/authorview_quiz.js');
	 */
	eventManager.fire('scriptLoaded', 'vle/node/highchartsTest/authorview_highchartsTest.js');
};