/*
 * This is a branching state object that developers can use to create new
 * step types.
 *
 ...
 * 
 * TODO: in this file, change all occurrences of the word 'BranchingState' to
 * 
 * <new step type>State
 * e.g. for example if you are creating a quiz step it would look
 ...
 * @constructor
 */
function BranchingState(response) {
 ...
 * @return a BranchingState object
 */
BranchingState.prototype.parseDataJSONObj = function(stateJSONObj) {
 ...
 */
BranchingState.prototype.getStudentWork = function() {
...
if(typeof eventManager != 'undefined'){
	//TODO: rename branching/branchingState.js
	eventManager.fire('scriptLoaded', 'vle/node/branching/branchingState.js');
}