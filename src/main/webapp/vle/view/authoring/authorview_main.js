...
View.prototype.exportProject = function(params){
	if(this.getProject() && this.portalProjectId){
		...
		window.open(contextPath + "/project/export/" + this.portalProjectId);
	} else {
...
View.prototype.onProjectLoaded = function(){
	if(this.cleanMode){
		...
		/*
		 * remember the WISE4 project base url which is used when converting
		 * the project to WISE5
		 */
		this.wise4ProjectBaseURL = this.config.getConfigParam("projectBaseURL");
