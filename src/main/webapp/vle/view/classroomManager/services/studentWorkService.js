...
.service('StudentWorkService', ['$http', '$q', 'ConfigService', 'ProjectService', 'UserAndClassInfoService', function($http, $q, ConfigService, ProjectService, UserAndClassInfoService) {
