...
TagMapConstraintFactory.createTagMapConstraint = function(view, nodeId, tagName, functionName, functionArgs, additionalFunctionArgs, customMessage) {
	...
	} else if(functionName == 'mustCreateXIdeaBasketIdeasOnThisStepBeforeAdvancing') {
		return new MustCreateXIdeaBasketIdeasOnThisStepBeforeAdvancingConstraint(view, nodeId, tagName, functionName, functionArgs, additionalFunctionArgs, customMessage);
	}
};
