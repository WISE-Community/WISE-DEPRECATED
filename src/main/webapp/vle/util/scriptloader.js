...
var scriptloader = function(){
	...
	var scripts = {
		...
		student: [jqueryUISrc,
			      ...
			      'vle/view/student/studentview_utils.js',
			      'vle/view/student/studentview_studentwork.js',
		...
		topMenu: ['vle/view/student/studentview_topmenu.js'],
		studentwork: ['vle/model/vlestate.js',
		              'vle/model/nodevisit.js'
		              ],
		annotations: ['vle/view/student/studentview_annotation.js'],
		maxscores: ['vle/model/MaxScore.js'],
		hint: ['vle/view/student/studentview_hint.js'],
		navigation: ['vle/navigation/NavigationLogic.js',
		            'vle/navigation/DFS.js',
		            'vle/navigation/NavigationPanel.js',
		            'vle/view/student/studentview_navigation.js',
		...
		uicontrol:['vle/view/student/studentview_uicontrol.js'],
	...
	var css = {
    	...
    	menu:[],
 		...
 		premadecomments:['vle/css/globalstyles.css',
 		                ...
 		                jqueryUICss],
 		teacherWebSocket:['vle/lib/DataTables/media/css/jquery.dataTables.css',
