...
globals [ sky-top earth-top temperature num-CO2 num-clouds starter frozen? sun-brightness]
...
to setup-world
  ...
  ask patches [                           ;; set colors of the world
      ...
      update-albedo ] 
   create-heat 20 [ set heading random 360 ;; start with some heat energy in the earth
...
to add-CO2  ;; adds 25 CO2 molecules to atmosphere at top of mountain
  let width sky-top - earth-top
