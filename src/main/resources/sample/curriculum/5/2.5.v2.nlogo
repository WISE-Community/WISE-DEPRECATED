...
globals [ sky-top earth-top temperature num-CO2 num-clouds starter albedo sun-brightness]
...
to setup-world
  ...
  ask patches [                           ;; set colors of the world
      ...
      update-albedo ] 
   create-heat 30 [ set heading random 360 ;; start with some heat energy in the earth
