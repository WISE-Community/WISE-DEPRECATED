...
/**
 * Interface for the command which updates a curnit for the Sail Data Service.
 * 
 ...
 * 
 */
public interface SdsCurnitUpdateCommand extends
		SdsCommand<SdsCurnit, HttpPutRequest> {
