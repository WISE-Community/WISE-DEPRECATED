...
/**
 * Interface for the command which updates an offering for the Sail Data
 * Service.
 * 
 ...
 * 
 */
public interface SdsOfferingUpdateCommand extends
        SdsCommand<SdsOffering, HttpPutRequest> {
