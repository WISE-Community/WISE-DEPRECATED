...
public interface HttpRestTransport {
   ...
   *
   * @param httpRequestData All the data required for this post request.
   * @return A <code>Map</code> of response headers where the key is the
   * header name and the value is the header value.
   * @throws HttpStatusCodeException for exceptions which should be handled by the calling method.
   */
  HttpResponse post(HttpPostRequest httpRequestData) throws HttpStatusCodeException;

  /**
   * Performs the GET operation given the data required for the get.
   * @param httpRequestData All the data required for this get request.
   * @return An <code>InputStream</code> containing the response body.
   * @throws HttpStatusCodeException for exceptions which are the result of getting an unexpected
   * HttpStatusCode in the response. These can be handled by the calling
   * method or ignored as required by the situation.
   */
  InputStream get(HttpGetRequest httpRequestData) throws HttpStatusCodeException;

  /**
   * Performs the PUT operation given the data required for the put.
   * @param httpRequestData All the data required for this put request
   * @return A HttpResponse response from making the PUT request
   * @throws HttpStatusCodeException for exceptions which should be handled by the calling method.
   */
  HttpResponse put(HttpPutRequest httpRequestData) throws HttpStatusCodeException;
