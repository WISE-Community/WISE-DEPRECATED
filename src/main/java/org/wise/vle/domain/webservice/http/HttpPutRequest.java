...
public final class HttpPutRequest extends AbstractHttpRequest {
  ...
  protected static final Map<String, String> EMPTY_STRING_MAP = Collections.emptyMap();
  ...
  public HttpPutRequest(final Map<String, String> requestHeaders,
      ...
      throws BadHeaderException {
    super(requestHeaders, EMPTY_STRING_MAP, relativeUrl, expectedResponseStatusCode);
